class PelisController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @peli.save
        format.html { redirect_to @peli, notice: 'Peli fué creada satisfactoriamente.' }
  ...
  def update
    respond_to do |format|
      if @peli.update(peli_params)
        format.html { redirect_to @peli, notice: 'Peli fué actualizada satisfactoriamente.' }
  ...
  def destroy
    @peli.destroy
    respond_to do |format|
      format.html { redirect_to pelis_url, notice: 'Peli fué eliminada satisfactoriamente.' }
  ...
  private
    ...
    def peli_params
      params.require(:peli).permit(:nombre, :genero, :imagen)
    end
end
